...
$myResult = mysqli_query($conn, "SELECT COUNT(*) AS total FROM blogpost WHERE user_id = $userID");
...
$totalPages = (int) ceil($totalBlogs / $blogsPerPage);
...
<head>
    ...
    <link rel="stylesheet" href="css/dashboard_v2.css?v=<?php echo time(); ?>">
...
<header class="hero-navbar <?php echo ($page > 1 || !empty($search)) ? 'hero-navbar-solid' : ''; ?>">
    <div class="hero-navbar-inner">
        ...
        <nav class="hero-nav-links">
            <a href="dashboard.php" class="hero-nav-item <?php echo ($page === 1 && empty($search)) ? 'active' : ''; ?>">Dashboard</a>
            <a href="dashboard.php#blogGrid" class="hero-nav-item <?php echo ($page > 1 || !empty($search)) ? 'active' : ''; ?>">Blogs</a>
...
<main class="main">
    ...
    <?php if ($page === 1) { ?>
        <section class="dashboard-slider">
            <article class="dashboard-slide slide-one active">
                ...
                <div class="slide-content">
                    <h1>Publish your thoughts,<br>your way.</h1>
                    <p>Create personal stories, useful articles and ideas that reflect your voice.</p>
                    <a href="create_blog.php" class="slide-button">Start writing</a>
                </div>
            </article>
            ...
            <article class="dashboard-slide slide-two">
                <div class="slide-overlay"></div>
                <div class="slide-content">
                    <h1>Every story becomes part<br>of your journey.</h1>
                    <p>Keep your writing organized and manage your published stories from one place.</p>
                    <a href="profile.php" class="slide-button">View profile</a>
                </div>
            </article>
            ...
            <article class="dashboard-slide slide-three">
                <div class="slide-overlay"></div>
                <div class="slide-content">
                    <h1>Give your ideas a place<br>to be discovered.</h1>
                    <p>Readers can open any story by selecting its blog card.</p>
                    <a href="#blogGrid" class="slide-button">Browse stories</a>
                </div>
            </article>

            <div class="slider-controls">
                <button class="slider-dot active" type="button" data-index="0"></button>
                <button class="slider-dot" type="button" data-index="1"></button>
                <button class="slider-dot" type="button" data-index="2"></button>
            </div>
        </section>
        ...
        <section class="summary-row">
            <article class="summary-card summary-cyan">
                ...
                <span>Stories on the platform</span>
            </article>

            <article class="summary-card summary-purple">
                <p>Your stories</p>
                <strong><?php echo $myBlogs; ?></strong>
                <span>Blogs written by you</span>
            </article>

            <article class="summary-card summary-magenta">
                <p>Current page</p>
                <strong><?php echo $page; ?></strong>
                <span>Eight stories per page</span>
            </article>
        </section>
    <?php } ?>
    ...
    <section class="blog-heading">
        ...
        <span>Click a card to read</span>
    </section>
            ...
            <div class="sidebar-guide-cards">
                ...
                <article class="guide-video-card">
                    ...
                    <div class="guide-card-body">
                        ...
                        <p class="guide-card-desc">Discover the essential structure of a high-performing blog post—from attention-grabbing titles and introduction hooks to structured body paragraphs.</p>
                        <div class="guide-card-footer">
    ...
    <nav class="pagination">
        ...
        <?php for ($i = 1; $i <= max(1, $totalPages); $i++) { ?>
            <a href="dashboard.php?page=<?php echo $i; ?>" class="<?php echo $i === $page ? 'active-page' : ''; ?>">
                <?php echo $i; ?>
            </a>
        <?php } ?>
...
<a href="create_blog.php" class="floating-add" aria-label="Create blog">+</a>
